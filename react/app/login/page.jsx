              ...
              <div className="grid gap-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-violet-500 focus:ring-violet-500 disabled:pointer-events-none disabled:opacity-50"
                      required
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      className="text-sm font-medium text-violet-600 decoration-2 hover:underline"
                ...
                <div className="flex items-center">
                  <div className="flex">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="mt-0.5 shrink-0 rounded border-gray-200 text-violet-600 focus:ring-violet-500"
                      checked={rememberMe}
